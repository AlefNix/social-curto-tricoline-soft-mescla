...
bntcorbasebranco.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#9C9B96");
  document.getElementById('CB').style.backgroundColor = "#9C9B96";
});

//base preta
const btncorbasepreto = document.getElementById('blackbase');
btncorbasepreto.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#6F726B");
  document.getElementById('CB').style.backgroundColor = "#6F726B";
});
//base azul
const btncorbaseazul = document.getElementById('bluebase');
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#677B8B");
  document.getElementById('CB').style.backgroundColor = "#677B8B";
});    
//base vermelha
...
document.getElementById('base2').addEventListener('click', function(e){
  ...
  bntcorbotoesbranco.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#9C9B96";
    document.getElementById('BT').style.backgroundColor = "#9C9B96";
  });

  //botoes preta
  const btncorbotoespreto = document.getElementById('blackbase1');
  btncorbotoespreto.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#6F726B";
    document.getElementById('BT').style.backgroundColor = "#6F726B";
  });
  //botoes azul
  const btncorbotoesazul = document.getElementById('bluebase1');
  btncorbotoesazul.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#677B8B";
    document.getElementById('BT').style.backgroundColor = "#677B8B";
  });    
  //botoes vermelha
  ...
  bntcorgolaEbranco.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#9C9B96";
    document.getElementById('golaEE').style.fill = "#9C9B96";
    document.getElementById('ge').style.backgroundColor = "#9C9B96";
  });
  //Gola exterior preta
  const btncorgolaEpreto = document.getElementById('blackbase2');
  btncorgolaEpreto.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#6F726B";
    document.getElementById('golaEE').style.fill = "#6F726B";
    document.getElementById('ge').style.backgroundColor = "#6F726B";
  });
  //Gola exterior azul
  const btncorgolaEazul = document.getElementById('bluebase2');
  btncorgolaEazul.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#677B8B";
    document.getElementById('golaEE').style.fill = "#677B8B";
    document.getElementById('ge').style.backgroundColor = "#677B8B";
  });    
  ...
  bntcorgolaIbranco.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#9C9B96";
    document.getElementById('gi').style.backgroundColor = "#9C9B96";
  });
  //Gola interior preta
  const btncorgolaIpreto = document.getElementById('blackbase3');
  btncorgolaIpreto.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#6F726B";
    document.getElementById('gi').style.backgroundColor = "#6F726B";
  });
  //Gola interior azul
  const btncorgolaIazul = document.getElementById('bluebase3');
  btncorgolaIazul.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#677B8B";
    document.getElementById('gi').style.backgroundColor = "#677B8B";
  });    
...
//punho branca
  ...
  bntcorpunhobranco.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#9C9B96";
    document.getElementById('punho1').style.fill = "#9C9B96";
    document.getElementById('PU').style.backgroundColor = "#9C9B96";
  });

  //punho preta
  const btncorpunhopreto = document.getElementById('blackbase4');
  btncorpunhopreto.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#6F726B";
    document.getElementById('punho1').style.fill = "#6F726B";
    document.getElementById('PU').style.backgroundColor = "#6F726B";
  });
  //punho azul
  const btncorpunhoazul = document.getElementById('bluebase4');
  btncorpunhoazul.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#677B8B";
    document.getElementById('punho1').style.fill = "#677B8B";
    document.getElementById('PU').style.backgroundColor = "#677B8B";
  });    
  //punho vermelha
  ...
  bntcorvistaEbranco.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#9C9B96";
    document.getElementById('VE').style.backgroundColor = "#9C9B96";
  });

  //vistaE preta
  const btncorvistaEpreto = document.getElementById('blackbase5');
  btncorvistaEpreto.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#6F726B";
    document.getElementById('VE').style.backgroundColor = "#6F726B";
  });
  //vistaE azul
  const btncorvistaEazul = document.getElementById('bluebase5');
  btncorvistaEazul.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#677B8B";
    document.getElementById('VE').style.backgroundColor = "#677B8B";
  });    
  //vistaE vermelha
